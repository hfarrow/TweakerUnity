	...
	public class SearchOptions
	{
		...
		public bool CheckMatch(string name, Assembly assembly, ScopeType scope, BindingType binding, WeakReference weakInstance = null)
		{
			...
			if (this.weakInstance != null)
			{
				...
				{
					object strongInstance = null;
					weakInstance.TryGetTarget(out strongInstance);

					object thisStrongInstance = null;
					this.weakInstance.TryGetTarget(out thisStrongInstance);
					if (thisStrongInstance != strongInstance)
					{
						return false;
					}
				}
